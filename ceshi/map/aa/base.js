$(function () {
    ...
    $('textarea, input, select').blur(function () {
        ...
        if (e.attr("data-validate")) {
            ...
            if ($checkstate) {
                ...
                e
                    .closest('.field')
                    .append('<div class="input-help"><ul>' + $checktext + '</ul></div>');
            }
        }
    });
    ...
    $showtips = function (e, title) {
        ...
        if (place == "left") {
            x = e
                .offset()
                .left - html.outerWidth() - 5;
            y = e
                .offset()
                .top - html.outerHeight() / 2 + e.outerHeight() / 2;
        } else if (place == "top") {
            x = e
                .offset()
                .left - html.outerWidth() / 2 + e.outerWidth() / 2;
            y = e
                .offset()
